...
/*@AssociationOverrides({@AssociationOverride(name = "pk.flight", joinColumns = @JoinColumn(name = "flight_id")),
    @AssociationOverride(name = "pk.booker", joinColumns = @JoinColumn(name = "booker"))})*/
